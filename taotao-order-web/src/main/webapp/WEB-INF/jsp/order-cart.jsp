...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="刘威"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="18706777692"/>
		<input type="hidden" name="orderShipping.receiverState" value="陕西"/>
		<input type="hidden" name="orderShipping.receiverCity" value="西安"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="雁塔区"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="西安电子科技大学"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">刘威</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">187****7692</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">陕西 西安雁塔区</div>
						<div class="adr-m" limit="30">西安电子科技大学北校区</div>
